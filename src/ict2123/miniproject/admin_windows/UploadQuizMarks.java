 ...
 */
public class UploadQuizMarks extends javax.swing.JFrame {

    String userName, userType;
    int userID;
    Connection conn;

    public UploadQuizMarks(String uName, int uID, String uType) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UploadQuizMarks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UploadQuizMarks().setVisible(true);
            }
        });
    }
